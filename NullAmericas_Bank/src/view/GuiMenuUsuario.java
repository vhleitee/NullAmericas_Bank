	...
	private void inicializarComponentes() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// CORREÇÃO: Verifica se a lista foi carregada antes de usar o .size()
				if (Main.getContasCarregadas() != null) {
					...
					System.out.println("Nenhuma conta foi carregada para este usuário.");
				}
				Main.carregarTransacoes();
			}
		...
		// miSobre.setAccelerator( KeyStroke.getKeyStroke( KeyEvent.VK_H,
	...
	private void definirEventos() {
		...
		miPessoaFisica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Ação de cadastro de Pessoa Física", "Informação",
		...
		miPessoaJuridica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// aqui vai o codigo para chamar o exemplo 8.3
				JOptionPane.showMessageDialog(null, "Ação de cadastro de Pessoa Jur�dica", "Informação",
						JOptionPane.QUESTION_MESSAGE);
			}
		});

		miCompra.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// aqui vai o codigo para chamar o exemplo 8.3
				JOptionPane.showMessageDialog(null, "Ação de cadastro de Compra", "Informação",
		...
		miProduto.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// aqui vai o codigo para chamar o exemplo 8.3
				JOptionPane.showMessageDialog(null, "Ação de cadastro de Produto", "Informação",
